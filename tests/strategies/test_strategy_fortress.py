...
@patch('option_auditor.strategies.fortress._get_market_regime', return_value=15.0) # VIX 15 -> Safety 1.7
...
@patch('option_auditor.common.data_utils.get_cached_market_data')
@patch('option_auditor.strategies.fortress._get_market_regime', return_value=30.0) # High VIX
