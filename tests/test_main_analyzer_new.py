...
from option_auditor.main_analyzer import analyze_csv, refresh_dashboard_data, _calculate_discipline_score
...
def test_calculate_discipline_score():
    ...
    open_pos = [{"dte": 10}]
    score, details = _calculate_discipline_score(strats, open_pos)
